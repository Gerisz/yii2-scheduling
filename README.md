...
```
php composer.phar require gerisz/yii2-scheduling "*"
```

or add

```json
"gerisz/yii2-scheduling": "*"
```
...
<?php
/**
 * @var \gerisz\scheduling\Schedule $schedule
 */
...
First of all, you should include dependency to the `gerisz\yii2-scheduling` into your composer.json:

```
...
'require': {
    "gerisz/yii2-schedule": "*"
}
...
```
...
```php
'schedule' => 'gerisz\scheduling\Schedule',
```
